    ...
    <form action="{{ route('subjects.store') }}" method="POST" class="space-y-4 bg-white p-6 rounded shadow">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
                ...
                <input type="number" name="number" class="border rounded w-full px-3 py-2" placeholder="مثال: 395">
            </div>
            <div>
                <label class="block text-sm font-medium">رمز المادة</label>
                <input type="text" name="code" class="border rounded w-full px-3 py-2" placeholder="مثال: EE393">
            </div>
            <div>
            ...
            <div>
                ...
                <input type="number" name="units" class="border rounded w-full px-3 py-2" min="0" max="10">
            </div>
            <div>
                <label class="block text-sm font-medium">الساعات</label>
                <input type="number" name="hours" class="border rounded w-full px-3 py-2" min="0" max="20">
            </div>
            <div>
                <label class="block text-sm font-medium">تعتمد على</label>
                <input type="text" name="depends_on" class="border rounded w-full px-3 py-2" placeholder="رمز/اسم المادة">
            </div>
            <div>
                <label class="block text-sm font-medium">بديلة عن</label>
                <input type="text" name="alternative_for" class="border rounded w-full px-3 py-2" placeholder="رمز/اسم المادة">
            </div>
            <div>
                <label class="block text-sm font-medium">المستخدم</label>
                <input type="text" name="user_name" class="border rounded w-full px-3 py-2" placeholder="admin">
            </div>
            <div>
