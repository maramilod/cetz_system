...
document.getElementById('department').addEventListener('change', function () {
  ...
  <select name="academic_term" class="w-full border rounded p-2" required>
    ...
    <option value="مستجد - خريف">مستجد - خريف</option>
    <option value="مستجد - ربيع">مستجد - ربيع</option>
    <option value="منتقل - خريف">منتقل - خريف</option>
    <option value="منتقل - ربيع">منتقل - ربيع</option>
    <option value="استضافة">استضافة</option>
    <option value="مستجد - سنة">مستجد - سنة</option>
    <option value="منتقل - سنة">منتقل - سنة</option>
</select>
        ...
        <div>
         ...
         <div>
          ...
          <input name="passport_number" class="w-full border rounded p-2" placeholder="أدخل رقم الجواز" required>
        </div>
