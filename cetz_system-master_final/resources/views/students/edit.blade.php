...
<div class="max-w-4xl mx-auto">
    ...
    <option value="">— اختر النظام الدراسي —</option>

    <option value="مستجد - خريف"
        {{ old('academic_term', $student->academic_term) == 'مستجد - خريف' ? 'selected' : '' }}>
        مستجد – خريف
    </option>

    <option value="مستجد - ربيع"
        {{ old('academic_term', $student->academic_term) == 'مستجد - ربيع' ? 'selected' : '' }}>
        مستجد – ربيع
    </option>

    <option value="منتقل - خريف"
        {{ old('academic_term', $student->academic_term) == 'منتقل - خريف' ? 'selected' : '' }}>
        منتقل – خريف
    </option>

    <option value="منتقل - ربيع"
        {{ old('academic_term', $student->academic_term) == 'منتقل - ربيع' ? 'selected' : '' }}>
        منتقل – ربيع
    </option>

    <option value="استضافة"
        {{ old('academic_term', $student->academic_term) == 'استضافة' ? 'selected' : '' }}>
        استضافة
    </option>

    <option value="مستجد - سنة"
        {{ old('academic_term', $student->academic_term) == 'مستجد - سنة' ? 'selected' : '' }}>
        مستجد – نظام السنة
    </option>

    <option value="منتقل - سنة"
        {{ old('academic_term', $student->academic_term) == 'منتقل - سنة' ? 'selected' : '' }}>
        منتقل – نظام السنة
    </option>
</select>
